...
router.post('/refresh', authorityMiddleware.requireAnyUser, authController.refreshUser);
router.head('/checkSession', authorityMiddleware.requireAnyUser, authController.checkSession)
